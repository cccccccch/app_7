<template>
  <div class="dont-disturb-setting device-option-normal">
    <title-bar @goBack="goBack" class="title-area">
      <template v-slot:title><span class="title">效果灯设置</span></template>
...
import { EnableEffectLightRep, UpdateEffectLightRep, endpointControlRep } from "../../../api/request";
  ...
  methods: {
    ...
    async clickEffect() {
      let params = {
        ...
        cmdKey: CMD_KEY.SET_WORK_LIGHT_ON_OFF,
        cmdValue1: !this.isTrunOnEffectLight ? "0" : "1"
      };
